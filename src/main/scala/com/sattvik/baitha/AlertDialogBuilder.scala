...
class AlertDialogBuilder(
  ...
  implicit val builderCreator: BuilderCreator = BuilderCreator.default
) {
  require(context != null)
  //  require(content != null)
  val builder = builderCreator.createBuilder(context)
...
object AlertDialogBuilder {
  ...
  trait BuilderCreator {
    def createBuilder(context: Context): AlertDialog.Builder
  }

  object BuilderCreator {
    val default = new BuilderCreator {
